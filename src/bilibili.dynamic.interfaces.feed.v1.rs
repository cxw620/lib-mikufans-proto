...
pub mod active_report_message {
    ...
    impl ReportAction {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ReportAction::None => "REPORT_ACTION_NONE",
                ReportAction::Exposure => "REPORT_ACTION_EXPOSURE",
                ReportAction::Click => "REPORT_ACTION_CLICK",
            }
        }
...
impl ConfigAbEntry {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ConfigAbEntry::None => "CONFIG_AB_ENTRY_NONE",
            ConfigAbEntry::PubPageTitle => "CONFIG_AB_ENTRY_PUB_PAGE_TITLE",
            ConfigAbEntry::SelectPicPanel => "CONFIG_AB_ENTRY_SELECT_PIC_PANEL",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl MaxPicCountType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            MaxPicCountType::MaxPicCountNine => "MAX_PIC_COUNT_NINE",
            MaxPicCountType::MaxPicCountEighteen => "MAX_PIC_COUNT_EIGHTEEN",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl PoiType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            PoiType::Tencent => "TENCENT",
            PoiType::City => "CITY",
            PoiType::Nation => "NATION",
            PoiType::Bili => "BILI",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
...
pub mod feed_server {
    ...
    impl<T: Feed> Clone for FeedServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Feed> tonic::server::NamedService for FeedServer<T> {
        const NAME: &'static str = "bilibili.dynamic.interfaces.feed.v1.Feed";
    }
}
