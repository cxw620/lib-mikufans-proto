...
impl IconPosition {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            IconPosition::Prefix => "IconPositionPrefix",
            IconPosition::Suffix => "IconPositionSuffix",
        }
    }
...
impl ItemContentType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ItemContentType::Unknown => "ItemContentTypeUnknown",
            ItemContentType::Text => "ItemContentTypeText",
            ItemContentType::Highlight => "ItemContentTypeHighlight",
            ItemContentType::Emoji => "ItemContentTypeEmoji",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl MessageActionType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            MessageActionType::Unknown => "MessageActionTypeUnknown",
            MessageActionType::Like => "MessageActionTypeLike",
            MessageActionType::Unlike => "MessageActionTypeUnlike",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl MessageItemType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            MessageItemType::Unknown => "MessageItemTypeUnknown",
            MessageItemType::Author => "MessageItemTypeAuthor",
            MessageItemType::Notice => "MessageItemTypeNotice",
            MessageItemType::Content => "MessageItemTypeContent",
            MessageItemType::Picture => "MessageItemTypePicture",
            MessageItemType::Addition => "MessageItemTypeAddition",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl MessageStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            MessageStatus::Normal => "MessageStatusNormal",
            MessageStatus::Audit => "MessageStatusAudit",
            MessageStatus::SelfSeen => "MessageStatusSelfSeen",
            MessageStatus::Delete => "MessageStatusDelete",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl MessageType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            MessageType::None => "MessageTypeNone",
            MessageType::Text => "MessageTypeText",
            MessageType::Image => "MessageTypeImage",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ServerStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ServerStatus::Unknown => "ServerStatusUnknown",
            ServerStatus::Online => "ServerStatusOnline",
            ServerStatus::Offline => "ServerStatusOffline",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl TopicStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            TopicStatus::Unknown => "TopicStatusUnknown",
            TopicStatus::Normal => "TopicStatusNormal",
            TopicStatus::Audit => "TopicStatusAudit",
            TopicStatus::Deleted => "TopicStatusDeleted",
            TopicStatus::AuditDeleted => "TopicStatusAuditDeleted",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl TopicTailType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            TopicTailType::Unknown => "TopicTailTypeUnknown",
            TopicTailType::UnreadGray => "TopicTailTypeUnreadGray",
            TopicTailType::UnreadRed => "TopicTailTypeUnreadRed",
            TopicTailType::Edit => "TopicTailTypeEdit",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl UpServerType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            UpServerType::Unknown => "UpServerTypeUnknown",
            UpServerType::Create => "UpServerTypeCreate",
            UpServerType::Up => "UpServerTypeUp",
            UpServerType::Follow => "UpServerTypeFollow",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
