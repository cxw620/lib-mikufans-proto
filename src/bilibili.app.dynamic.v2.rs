...
pub mod creation_item_action {
    ...
    impl CreationAction {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                CreationAction::Invalid => "CREATION_ACTION_INVALID",
                CreationAction::Delete => "CREATION_ACTION_DELETE",
                CreationAction::EditDyn => "CREATION_ACTION_EDIT_DYN",
                CreationAction::JumpUrl => "CREATION_ACTION_JUMP_URL",
                CreationAction::RetractCv => "CREATION_ACTION_RETRACT_CV",
                CreationAction::EditCv => "CREATION_ACTION_EDIT_CV",
            }
        }
...
pub mod ext_info_common {
    ...
    impl ExtTagStyle {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ExtTagStyle::Default => "EXT_TAG_STYLE_DEFAULT",
                ExtTagStyle::PureText => "EXT_TAG_STYLE_PURE_TEXT",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod paragraph {
    ...
    impl ParagraphType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ParagraphType::InvalidParagraphType => "INVALID_ParagraphType",
...
pub mod pic_paragraph {
    ...
    impl PicParagraphStyle {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                PicParagraphStyle::InvalidPicParagraphStyle => {
...
pub mod text_node {
    ...
    impl TextNodeType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                TextNodeType::InvalidTextNodeType => "INVALID_TextNodeType",
                TextNodeType::Words => "WORDS",
                TextNodeType::Emote => "EMOTE",
                TextNodeType::AtTextNodeType => "AT_TextNodeType",
                TextNodeType::BizLink => "BIZ_LINK",
                TextNodeType::Formula => "FORMULA",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl AdditionalType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            AdditionalType::Article => "additional_type_article",
            AdditionalType::LiveRoom => "additional_type_live_room",
            AdditionalType::Music => "additional_type_music",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl CoverIcon {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            CoverIcon::ViewCnt => "cover_icon_view_cnt",
            CoverIcon::ThumbUp => "cover_icon_thumb_up",
            CoverIcon::Reply => "cover_icon_reply",
            CoverIcon::Fav => "cover_icon_fav",
            CoverIcon::Coin => "cover_icon_coin",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl DynExtendType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            DynExtendType::DynExtTypeArticleTag => "dyn_ext_type_article_tag",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl DynModuleType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            DynModuleType::ModuleOnetimeNotice => "module_onetime_notice",
            DynModuleType::ModuleSneakingAd => "module_sneaking_ad",
            DynModuleType::ModuleMangaHorizontalPagePicContent => {
                "module_manga_horizontal_page_pic_content"
            }
            DynModuleType::ModuleMangaVerticalSlidePicContent => {
                "module_manga_vertical_slide_pic_content"
            }
            DynModuleType::ModuleMangaCoverPicContent => "module_manga_cover_pic_content",
            DynModuleType::ModuleAuthorForSubscribe => "module_author_for_subscribe",
            DynModuleType::ModuleAuthorSlim => "module_author_slim",
            DynModuleType::ModuleMangaCollection => "module_manga_collection",
            DynModuleType::ModuleCooperation => "module_cooperation",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl DynamicType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            DynamicType::OnetimeNotice => "onetime_notice",
            DynamicType::MangaEp => "manga_ep",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl EmoteClickAction {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            EmoteClickAction::EmoteClickNone => "EMOTE_CLICK_NONE",
            EmoteClickAction::EmoteClickPopupPreview => "EMOTE_CLICK_POPUP_PREVIEW",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl FlowItemType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            FlowItemType::Invalid => "FLOW_ITEM_TYPE_INVALID",
            FlowItemType::Opus => "FLOW_ITEM_TYPE_OPUS",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl LinkNodeType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            LinkNodeType::Music => "MUSIC",
            LinkNodeType::GptRcmdQuestion => "GPT_RCMD_QUESTION",
            LinkNodeType::MemberTicket => "MEMBER_TICKET",
            LinkNodeType::RepostPicUrl => "REPOST_PIC_URL",
            LinkNodeType::RepostPicDynUrl => "REPOST_PIC_DYN_URL",
            LinkNodeType::OgvFollowCard => "OGV_FOLLOW_CARD",
            LinkNodeType::ArticleGoods => "ARTICLE_GOODS",
            LinkNodeType::ArticleTag => "ARTICLE_TAG",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl MangaLikePageDirection {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            MangaLikePageDirection::PageDirectionInvalid => "PAGE_DIRECTION_INVALID",
            MangaLikePageDirection::PageDirectionLeftToRight => {
                "PAGE_DIRECTION_LEFT_TO_RIGHT"
            }
            MangaLikePageDirection::PageDirectionRightToLeft => {
                "PAGE_DIRECTION_RIGHT_TO_LEFT"
            }
            MangaLikePageDirection::PageDirectionLeftToRightRotate => {
...
impl MangaLikePicClickAction {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            MangaLikePicClickAction::ClickActNone => "CLICK_ACT_NONE",
            MangaLikePicClickAction::ClickActMangaBrowser => "CLICK_ACT_MANGA_BROWSER",
            MangaLikePicClickAction::ClickActNormalBrowser => "CLICK_ACT_NORMAL_BROWSER",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl MdlBlockedStyle {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            MdlBlockedStyle::BlockedStyleMangaPurchase => "BLOCKED_STYLE_MANGA_PURCHASE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ModuleDynamicType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            ModuleDynamicType::MdlDynCourUp => "mdl_dyn_cour_up",
            ModuleDynamicType::MdlDynTopicSet => "mdl_dyn_topic_set",
            ModuleDynamicType::MdlDynChargingArchive => "mdl_dyn_charging_archive",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl OpusType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            OpusType::Repost => "OPUS_TYPE_REPOST",
            OpusType::MangaEp => "OPUS_TYPE_MANGA_EP",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ThreePointType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            ThreePointType::BatchCancel => "batch_cancel",
            ThreePointType::TopicSetCancel => "topic_set_cancel",
            ThreePointType::DynamicEdit => "dynamic_edit",
            ThreePointType::CreateVideo => "create_video",
            ThreePointType::Coin => "coin",
            ThreePointType::OgvSubscribe => "ogv_subscribe",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod campus_server {
    ...
    #[async_trait]
    pub trait Campus: Send + Sync + 'static {
        ///
    ...
    ///
    #[derive(Debug)]
    pub struct CampusServer<T: Campus> {
        inner: Arc<T>,
    ...
    impl<T: Campus> Clone for CampusServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Campus> tonic::server::NamedService for CampusServer<T> {
        const NAME: &'static str = "bilibili.app.dynamic.v2.Campus";
    }
}
/// Generated server implementations.
pub mod dynamic_server {
    ...
    #[async_trait]
    pub trait Dynamic: Send + Sync + 'static {
        ///
    ...
    ///
    #[derive(Debug)]
    pub struct DynamicServer<T: Dynamic> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T: Dynamic> DynamicServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T: Dynamic> Clone for DynamicServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Dynamic> tonic::server::NamedService for DynamicServer<T> {
        const NAME: &'static str = "bilibili.app.dynamic.v2.Dynamic";
    }
}
/// Generated server implementations.
pub mod opus_server {
    ...
    #[async_trait]
    pub trait Opus: Send + Sync + 'static {
        ///
    ...
    impl<T: Opus> Clone for OpusServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Opus> tonic::server::NamedService for OpusServer<T> {
        const NAME: &'static str = "bilibili.app.dynamic.v2.Opus";
    }
}
