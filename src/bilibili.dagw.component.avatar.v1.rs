...
pub mod basic_layer_resource {
    ...
    impl ResType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ResType::Invalid => "RES_TYPE_INVALID",
                ResType::Plugin => "RES_TYPE_PLUGIN",
                ResType::Empty => "RES_TYPE_EMPTY",
                ResType::Image => "RES_TYPE_IMAGE",
                ResType::Animation => "RES_TYPE_ANIMATION",
                ResType::NativeDraw => "RES_TYPE_NATIVE_DRAW",
            }
        }
...
pub mod layer_tag_config {
    ...
    impl TagConfigType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                TagConfigType::TagCfgInvalid => "TAG_CFG_INVALID",
                TagConfigType::TagCfgGeneral => "TAG_CFG_GENERAL",
                TagConfigType::TagCfgGyro => "TAG_CFG_GYRO",
                TagConfigType::TagCfgCommentDoubleClick => "TAG_CFG_COMMENT_DOUBLE_CLICK",
                TagConfigType::TagCfgInLive => "TAG_CFG_IN_LIVE",
                TagConfigType::TagCfgWebInLive => "TAG_CFG_WEB_IN_LIVE",
                TagConfigType::TagCfgFollowIcon => "TAG_CFG_FOLLOW_ICON",
                TagConfigType::TagCfgFollowAction => "TAG_CFG_FOLLOW_ACTION",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
