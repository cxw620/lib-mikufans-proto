...
impl ECode {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            ECode::Codeversionlimit => "CODEVERSIONLIMIT",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl JumpShowType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            JumpShowType::JstDefault => "JST_DEFAULT",
            JumpShowType::JstFullscreen => "JST_FULLSCREEN",
            JumpShowType::JstHalfscreen => "JST_HALFSCREEN",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl PlayToastEnum {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            PlayToastEnum::PlaytoastUnknown => "PLAYTOAST_UNKNOWN",
            PlayToastEnum::PlaytoastChargingplus => "PLAYTOAST_CHARGINGPLUS",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl PlayerCardType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            PlayerCardType::None => "PlayerCardTypeNone",
            PlayerCardType::Attention => "PlayerCardTypeAttention",
            PlayerCardType::Operation => "PlayerCardTypeOperation",
            PlayerCardType::Contract => "PlayerCardTypeContract",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl RejectPageEnum {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            RejectPageEnum::RejectpageUnknown => "REJECTPAGE_UNKNOWN",
            RejectPageEnum::RejectpageChargingplus => "REJECTPAGE_CHARGINGPLUS",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ViewState {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ViewState::ViewNone => "ViewNone",
            ViewState::ViewHostOnlySelf => "ViewHostOnlySelf",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod legacy_view_server {
    ...
    ///
    #[derive(Debug)]
    pub struct LegacyViewServer<T: LegacyView> {
        inner: Arc<T>,
    ...
    impl<T: LegacyView> LegacyViewServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T: LegacyView> Clone for LegacyViewServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: LegacyView> tonic::server::NamedService for LegacyViewServer<T> {
        const NAME: &'static str = "bilibili.app.view.v1.LegacyView";
    }
}
/// Generated server implementations.
pub mod view_server {
    ...
    impl<T: View> tonic::server::NamedService for ViewServer<T> {
        const NAME: &'static str = "bilibili.app.view.v1.View";
    }
}
