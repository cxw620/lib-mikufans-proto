...
pub mod wall_server {
    ...
    #[async_trait]
    pub trait Wall: Send + Sync + 'static {
        ///
        async fn rule_info(
            &self,
    ...
    impl<T: Wall> Clone for WallServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Wall> tonic::server::NamedService for WallServer<T> {
        const NAME: &'static str = "bilibili.app.wall.v1.Wall";
    }
}
