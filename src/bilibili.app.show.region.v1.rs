...
pub mod region_server {
    ...
    ///
    #[derive(Debug)]
    pub struct RegionServer<T: Region> {
        inner: Arc<T>,
    ...
    impl<T: Region> Clone for RegionServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Region> tonic::server::NamedService for RegionServer<T> {
        const NAME: &'static str = "bilibili.app.show.region.v1.Region";
    }
}
