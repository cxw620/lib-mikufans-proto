...
pub mod at_group {
    ...
    impl Type {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Type::AtGroupTypeDefault => "AT_GROUP_TYPE_DEFAULT",
                Type::AtGroupTypeRecent => "AT_GROUP_TYPE_RECENT",
                Type::AtGroupTypeFollow => "AT_GROUP_TYPE_FOLLOW",
                Type::AtGroupTypeFans => "AT_GROUP_TYPE_FANS",
                Type::AtGroupTypeOthers => "AT_GROUP_TYPE_OTHERS",
            }
        }
    ...
    impl Action {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Action::ShowKeyboard => "SHOW_KEYBOARD",
                Action::SendReplyWithBoldText => "SEND_REPLY_WITH_BOLD_TEXT",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
    ...
    pub mod nft {
        ...
        pub mod interaction {
            ...
            impl RegionType {
                ...
                pub fn as_str_name(&self) -> &'static str {
                    match self {
                        RegionType::DefaultRegionType => "DEFAULT_RegionType",
                        RegionType::MainlandRegionType => "MAINLAND_RegionType",
                        RegionType::GatRegionType => "GAT_RegionType",
                    }
                }
                /// Creates an enum from field names used in the ProtoBuf definition.
                pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            ...
            impl ShowStatus {
                ...
                pub fn as_str_name(&self) -> &'static str {
                    match self {
                        ShowStatus::ShowdefaultShowStatus => "SHOWDEFAULT_ShowStatus",
                        ShowStatus::ZoominmainlandShowStatus => {
                            "ZOOMINMAINLAND_ShowStatus"
                        }
                        ShowStatus::RawShowStatus => "RAW_ShowStatus",
                    }
                }
                /// Creates an enum from field names used in the ProtoBuf definition.
                pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod reply_control {
    ...
    pub mod vote_option {
        ...
        impl LabelKind {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    LabelKind::DefaultLabelKind => "DEFAULT_LabelKind",
                    LabelKind::Red => "RED",
                    LabelKind::Blue => "BLUE",
                    LabelKind::Plain => "PLAIN",
                }
            }
            /// Creates an enum from field names used in the ProtoBuf definition.
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod url {
    ...
    pub mod extra {
        ...
        impl GoodsShowType {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    GoodsShowType::Popup => "Popup",
                    GoodsShowType::FullScreen => "FullScreen",
                    GoodsShowType::HalfScreen => "HalfScreen",
                }
            }
            /// Creates an enum from field names used in the ProtoBuf definition.
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl EditorIconState {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            EditorIconState::Default => "EditorIconState_DEFAULT",
            EditorIconState::Enable => "EditorIconState_ENABLE",
            EditorIconState::Disable => "EditorIconState_DISABLE",
            EditorIconState::Hide => "EditorIconState_HIDE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl UserCallbackScene {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            UserCallbackScene::InsertUserCallbackScene => "Insert_UserCallbackScene",
            UserCallbackScene::RecommendSuperbReply => "RecommendSuperbReply",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod reply_server {
    ...
    ///
    #[derive(Debug)]
    pub struct ReplyServer<T: Reply> {
        inner: Arc<T>,
    ...
    impl<T: Reply> Clone for ReplyServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Reply> tonic::server::NamedService for ReplyServer<T> {
        const NAME: &'static str = "bilibili.main.community.reply.v1.Reply";
    }
}
