...
pub mod dyn_red_req {
    ...
    impl DynRedReqScene {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                DynRedReqScene::RedReqNone => "RED_REQ_NONE",
                DynRedReqScene::RedReqReturnToTab1 => "RED_REQ_RETURN_TO_TAB_1",
                DynRedReqScene::RedReqPeriodicallyAwake => "RED_REQ_PERIODICALLY_AWAKE",
                DynRedReqScene::RedReqSwitchAccount => "RED_REQ_SWITCH_ACCOUNT",
            }
        }
...
impl BubbleModuleType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            BubbleModuleType::BubbleModuleNone => "BUBBLE_MODULE_NONE",
            BubbleModuleType::BubbleModuleUser => "BUBBLE_MODULE_USER",
            BubbleModuleType::BubbleModuleText => "BUBBLE_MODULE_TEXT",
            BubbleModuleType::BubbleModuleColoredTip => "BUBBLE_MODULE_COLORED_TIP",
            BubbleModuleType::BubbleModulePic => "BUBBLE_MODULE_PIC",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl CornerType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            CornerType::Static => "corner_type_static",
            CornerType::RedDot => "corner_type_red_dot",
            CornerType::Number => "corner_type_number",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl StyleType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            StyleType::OgvUp => "STYLE_TYPE_OGV_UP",
            StyleType::CollectionUp => "STYLE_TYPE_COLLECTION_UP",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod dynamic_server {
    ...
    impl<T: Dynamic> tonic::server::NamedService for DynamicServer<T> {
        const NAME: &'static str = "bilibili.app.dynamic.v1.Dynamic";
    }
}
