...
impl AttentionRelationStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            AttentionRelationStatus::ArsNone => "ARS_NONE",
            AttentionRelationStatus::ArsN0relation => "ARS_N0RELATION",
            AttentionRelationStatus::ArsFollowhim => "ARS_FOLLOWHIM",
            AttentionRelationStatus::ArsFollowme => "ARS_FOLLOWME",
            AttentionRelationStatus::ArsBuddy => "ARS_BUDDY",
            AttentionRelationStatus::ArsSpecial => "ARS_SPECIAL",
            AttentionRelationStatus::ArsCancelblock => "ARS_CANCELBLOCK",
        }
    }
...
impl ExtType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ExtType::ExtNone => "ExtNone",
            ExtType::ExtDataCenter => "ExtDataCenter",
            ExtType::ExtDataEarnings => "ExtDataEarnings",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl HonorJumpType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            HonorJumpType::Unknown => "HONOR_JUMP_TYPE_UNKNOWN",
            HonorJumpType::HonorOpenUrl => "HONOR_OPEN_URL",
            HonorJumpType::HonorHalfScreen => "HONOR_HALF_SCREEN",
            HonorJumpType::HonorPopup => "HONOR_POPUP",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl HonorType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            HonorType::HonorNone => "HONOR_NONE",
            HonorType::Playlet => "PLAYLET",
            HonorType::Argue => "ARGUE",
            HonorType::Notice => "NOTICE",
            HonorType::Guidance => "GUIDANCE",
            HonorType::HonorBiliRank => "HONOR_BILI_RANK",
            HonorType::HonorWeeklyRank => "HONOR_WEEKLY_RANK",
            HonorType::HonorDailyRank => "HONOR_DAILY_RANK",
            HonorType::HonorChannel => "HONOR_CHANNEL",
...
impl JumpType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            JumpType::Unknown => "JUMP_TYPE_UNKNOWN",
            JumpType::OpenUrl => "OPEN_URL",
            JumpType::Refresh => "REFRESH",
            JumpType::HalfScreen => "HALF_SCREEN",
            JumpType::OpenUrlByOuterBrowser => "OPEN_URL_BY_OUTER_BROWSER",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl KingPositionType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            KingPositionType::KingPosUnspecified => "KING_POS_UNSPECIFIED",
            KingPositionType::Like => "LIKE",
            KingPositionType::Dislike => "DISLIKE",
            KingPositionType::Coin => "COIN",
            KingPositionType::Fav => "FAV",
            KingPositionType::Share => "SHARE",
            KingPositionType::Cache => "CACHE",
            KingPositionType::Danmaku => "DANMAKU",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ModuleType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            ModuleType::OgvIntroduction => "OGV_INTRODUCTION",
            ModuleType::OgvTitle => "OGV_TITLE",
            ModuleType::UgcHeadline => "UGC_HEADLINE",
            ModuleType::UgcIntroduction => "UGC_INTRODUCTION",
            ModuleType::KingPosition => "KING_POSITION",
            ModuleType::MasterUserList => "MASTER_USER_LIST",
            ModuleType::Staffs => "STAFFS",
            ModuleType::Honor => "HONOR",
            ModuleType::Owner => "OWNER",
            ModuleType::Page => "PAGE",
            ModuleType::ActivityReserve => "ACTIVITY_RESERVE",
            ModuleType::LiveOrder => "LIVE_ORDER",
            ModuleType::Positive => "POSITIVE",
            ModuleType::Section => "SECTION",
            ModuleType::Relate => "RELATE",
            ModuleType::Pugv => "PUGV",
            ModuleType::CollectionCard => "COLLECTION_CARD",
            ModuleType::Activity => "ACTIVITY",
            ModuleType::Character => "CHARACTER",
            ModuleType::FollowLayer => "FOLLOW_LAYER",
            ModuleType::OgvSeasons => "OGV_SEASONS",
            ModuleType::UgcSeason => "UGC_SEASON",
            ModuleType::OgvLiveReserve => "OGV_LIVE_RESERVE",
            ModuleType::CombinationEpisode => "COMBINATION_EPISODE",
            ModuleType::Sponsor => "SPONSOR",
            ModuleType::ActivityEntrance => "ACTIVITY_ENTRANCE",
            ModuleType::TheatreHotTopic => "THEATRE_HOT_TOPIC",
            ModuleType::RelatedRecommend => "RELATED_RECOMMEND",
            ModuleType::PayBar => "PAY_BAR",
            ModuleType::Banner => "BANNER",
            ModuleType::Audio => "AUDIO",
            ModuleType::AggCard => "AGG_CARD",
            ModuleType::SingleEp => "SINGLE_EP",
            ModuleType::LikeComment => "LIKE_COMMENT",
            ModuleType::AttentionRecommend => "ATTENTION_RECOMMEND",
            ModuleType::Covenanter => "COVENANTER",
            ModuleType::Specialtag => "SPECIALTAG",
            ModuleType::Updata => "UPDATA",
            ModuleType::ProfessionApproval => "PROFESSION_APPROVAL",
            ModuleType::PugvShoppingNotice => "PUGV_SHOPPING_NOTICE",
            ModuleType::PugvFaq => "PUGV_FAQ",
            ModuleType::PugvSeasonDescription => "PUGV_SEASON_DESCRIPTION",
            ModuleType::PugvSeasonRecommend => "PUGV_SEASON_RECOMMEND",
            ModuleType::PugvSeasonPublisher => "PUGV_SEASON_PUBLISHER",
            ModuleType::PugvSeasonSelection => "PUGV_SEASON_SELECTION",
            ModuleType::PugvSeasonPrimaryInfo => "PUGV_SEASON_PRIMARY_INFO",
            ModuleType::PugvCooperationApplication => "PUGV_COOPERATION_APPLICATION",
            ModuleType::UpVideoTool => "UP_VIDEO_TOOL",
            ModuleType::PugvZone => "PUGV_ZONE",
            ModuleType::PugvSeries => "PUGV_SERIES",
            ModuleType::PugvPackage => "PUGV_PACKAGE",
            ModuleType::ActivityStarRail => "ACTIVITY_STAR_RAIL",
            ModuleType::ActivityIframe => "ACTIVITY_IFRAME",
            ModuleType::PlayList => "PLAY_LIST",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl OccupationType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            OccupationType::Staff => "STAFF",
            OccupationType::Cast => "CAST",
            OccupationType::UnknownType => "UNKNOWN_TYPE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl PugvSeasonDescriptionType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            PugvSeasonDescriptionType::Unspecified => {
                "PUGV_SEASON_DESCRIPTION_TYPE_UNSPECIFIED"
            }
            PugvSeasonDescriptionType::Text => "PUGV_SEASON_DESCRIPTION_TYPE_TEXT",
            PugvSeasonDescriptionType::Image => "PUGV_SEASON_DESCRIPTION_TYPE_IMAGE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl PugvSeasonPrimarySellPointType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            PugvSeasonPrimarySellPointType::Unspecified => {
                "PUGV_SEASON_PRIMARY_SELL_POINT_TYPE_UNSPECIFIED"
            }
            PugvSeasonPrimarySellPointType::Manual => {
                "PUGV_SEASON_PRIMARY_SELL_POINT_TYPE_MANUAL"
            }
            PugvSeasonPrimarySellPointType::Auto => {
...
impl PugvSeasonRecommendShowStyle {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            PugvSeasonRecommendShowStyle::Unspecified => {
                "PUGV_SEASON_RECOMMEND_SHOW_STYLE_UNSPECIFIED"
            }
            PugvSeasonRecommendShowStyle::More => "PUGV_SEASON_RECOMMEND_SHOW_STYLE_MORE",
            PugvSeasonRecommendShowStyle::Feed => "PUGV_SEASON_RECOMMEND_SHOW_STYLE_FEED",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl PugvSeriesItemState {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            PugvSeriesItemState::PugvSeriresItemStateUnspecial => {
                "PUGV_SERIRES_ITEM_STATE_UNSPECIAL"
            }
            PugvSeriesItemState::PugvSeriresItemStateNotStart => {
                "PUGV_SERIRES_ITEM_STATE_NOT_START"
            }
            PugvSeriesItemState::PugvSeriresItemStateStart => {
                "PUGV_SERIRES_ITEM_STATE_START"
            }
            PugvSeriesItemState::PugvSeriresItemStateEnd => "PUGV_SERIRES_ITEM_STATE_END",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl PugvZoneItemType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            PugvZoneItemType::Unspecified => "PUGV_ZONE_ITEM_TYPE_UNSPECIFIED",
            PugvZoneItemType::Season => "PUGV_ZONE_ITEM_TYPE_SEASON",
            PugvZoneItemType::Postgraduate => "PUGV_ZONE_ITEM_TYPE_POSTGRADUATE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl RelateCardType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            RelateCardType::CardTypeUnknown => "CARD_TYPE_UNKNOWN",
            RelateCardType::Av => "AV",
            RelateCardType::Bangumi => "BANGUMI",
            RelateCardType::Resource => "RESOURCE",
            RelateCardType::Game => "GAME",
            RelateCardType::Cm => "CM",
            RelateCardType::Live => "LIVE",
            RelateCardType::AiRecommend => "AI_RECOMMEND",
            RelateCardType::BangumiAv => "BANGUMI_AV",
            RelateCardType::BangumiUgc => "BANGUMI_UGC",
            RelateCardType::Special => "SPECIAL",
            RelateCardType::Course => "COURSE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ReserveBizType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ReserveBizType::BizTypeNone => "BizTypeNone",
            ReserveBizType::BizTypeReserveActivity => "BizTypeReserveActivity",
            ReserveBizType::BizTypeFavSeason => "BizTypeFavSeason",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl SerialSeasonCoverStyle {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            SerialSeasonCoverStyle::Title => "TITLE",
            SerialSeasonCoverStyle::Picture => "PICTURE",
            SerialSeasonCoverStyle::Unknown => "SERIAL_SEASON_COVER_STYLE_UNKNOWN",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ShowStyle {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ShowStyle::Unknown => "SHOW_STYLE_UNKNOWN",
            ShowStyle::OneRowOneColumn => "ONE_ROW_ONE_COLUMN",
            ShowStyle::OneRowMultiColumn => "ONE_ROW_MULTI_COLUMN",
            ShowStyle::OneColumnMultiRow => "ONE_COLUMN_MULTI_ROW",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ToolType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ToolType::InteractiveDanmaku => "INTERACTIVE_DANMAKU",
            ToolType::InteractiveSettings => "INTERACTIVE_SETTINGS",
            ToolType::TakeOff => "TAKE_OFF",
            ToolType::Universal => "UNIVERSAL",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
