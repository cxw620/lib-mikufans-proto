...
impl MsgLikeAction {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            MsgLikeAction::ActionUnspecified => "ACTION_UNSPECIFIED",
            MsgLikeAction::ActionLike => "ACTION_LIKE",
            MsgLikeAction::ActionCancelLike => "ACTION_CANCEL_LIKE",
            MsgLikeAction::ActionDislike => "ACTION_DISLIKE",
            MsgLikeAction::ActionCancelDislike => "ACTION_CANCEL_DISLIKE",
        }
    }
...
impl MsgLikeState {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            MsgLikeState::StateUnspecified => "STATE_UNSPECIFIED",
            MsgLikeState::StateLike => "STATE_LIKE",
            MsgLikeState::StateDislike => "STATE_DISLIKE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl UpdateUnreadScope {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            UpdateUnreadScope::All => "All",
            UpdateUnreadScope::Dustbin => "Dustbin",
            UpdateUnreadScope::Unfollowed => "Unfollowed",
            UpdateUnreadScope::Stranger => "Stranger",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod im_interface_server {
    ...
    #[async_trait]
    pub trait ImInterface: Send + Sync + 'static {
        ///
    ...
    ///
    #[derive(Debug)]
    pub struct ImInterfaceServer<T: ImInterface> {
        inner: Arc<T>,
    ...
    impl<T: ImInterface> ImInterfaceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T: ImInterface> Clone for ImInterfaceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: ImInterface> tonic::server::NamedService for ImInterfaceServer<T> {
        const NAME: &'static str = "bilibili.im.interfaces.v1.ImInterface";
    }
}
