...
impl MsgFeedActionType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            MsgFeedActionType::Invalid => "MSG_FEED_ACTION_TYPE_INVALID",
            MsgFeedActionType::Thank => "MSG_FEED_ACTION_TYPE_THANK",
        }
    }
...
impl MsgFeedFilterType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            MsgFeedFilterType::MsgFeedAll => "MsgFeed_All",
            MsgFeedFilterType::MsgFeedFollowing => "MsgFeed_Following",
            MsgFeedFilterType::MsgFeedAtMe => "MsgFeed_AtMe",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl MsgFeedMsgType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            MsgFeedMsgType::LikeMsg => "LikeMsg",
            MsgFeedMsgType::ReplyMsg => "ReplyMsg",
            MsgFeedMsgType::AtMsg => "AtMsg",
            MsgFeedMsgType::DanmuMsg => "DanmuMsg",
            MsgFeedMsgType::CoinMsg => "CoinMsg",
            MsgFeedMsgType::FavoriteMsg => "FavoriteMsg",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl MsgTabType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            MsgTabType::LikeMe => "LikeMe",
            MsgTabType::ReplyMe => "ReplyMe",
            MsgTabType::AtMe => "AtMe",
            MsgTabType::SystemMsg => "SystemMsg",
            MsgTabType::HuaHuo => "HuaHuo",
            MsgTabType::NewFollow => "NewFollow",
            MsgTabType::ReceiveReply => "ReceiveReply",
            MsgTabType::ReceiveLike => "ReceiveLike",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl SessionsFilterType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            SessionsFilterType::SessionsAll => "Sessions_All",
            SessionsFilterType::SessionsFollowing => "Sessions_Following",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod im_gateway_api_server {
    ...
    #[async_trait]
    pub trait ImGatewayApi: Send + Sync + 'static {
        ///
    ...
    ///
    #[derive(Debug)]
    pub struct ImGatewayApiServer<T: ImGatewayApi> {
        inner: Arc<T>,
    ...
    impl<T: ImGatewayApi> ImGatewayApiServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T: ImGatewayApi> Clone for ImGatewayApiServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: ImGatewayApi> tonic::server::NamedService for ImGatewayApiServer<T> {
        const NAME: &'static str = "bilibili.im.gateway.interfaces.v1.ImGatewayApi";
    }
}
