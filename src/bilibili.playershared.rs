...
pub mod scheme {
    ...
    impl ActionType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ActionType::UnknownActionType => "UNKNOWN_ActionType",
...
pub struct SettingItem {
    ...
    pub style: i32,
    ///
    #[prost(oneof = "setting_item::Value", tags = "3")]
...
impl BizType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            BizType::Unknown => "BIZ_TYPE_UNKNOWN",
            BizType::Ugc => "BIZ_TYPE_UGC",
            BizType::Pgc => "BIZ_TYPE_PGC",
            BizType::Pugv => "BIZ_TYPE_PUGV",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ButtonAction {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ButtonAction::ButtonUnknown => "BUTTON_UNKNOWN",
            ButtonAction::Pay => "PAY",
            ButtonAction::Vip => "VIP",
            ButtonAction::Pack => "PACK",
            ButtonAction::Link => "LINK",
            ButtonAction::Coupon => "COUPON",
            ButtonAction::Demand => "DEMAND",
            ButtonAction::DemandPack => "DEMAND_PACK",
            ButtonAction::Follow => "FOLLOW",
            ButtonAction::Appointment => "APPOINTMENT",
            ButtonAction::VipFree => "VIP_FREE",
            ButtonAction::Task => "TASK",
            ButtonAction::Chargingplus => "CHARGINGPLUS",
            ButtonAction::Bp => "BP",
            ButtonAction::PreSell => "PRE_SELL",
            ButtonAction::Login => "LOGIN",
            ButtonAction::CheesePay => "BUTTON_ACTION_CHEESE_PAY",
            ButtonAction::DeliverReport => "DELIVER_REPORT",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ConfType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            ConfType::WatchLater => "WATCH_LATER",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl Effects {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Effects::Unknown => "EFFECTS_UNKNOWN",
            Effects::GaussianBlur => "GAUSSIAN_BLUR",
            Effects::HalfAlpha => "HALF_ALPHA",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ExtDataType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ExtDataType::Unknown => "EXT_DATA_TYPE_UNKNOWN",
            ExtDataType::PlayList => "PLAY_LIST",
            ExtDataType::Banner => "BANNER",
            ExtDataType::HeInline => "HE_INLINE",
            ExtDataType::Charging => "EXT_DATA_TYPE_CHARGING",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl FoldStyle {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            FoldStyle::Unspecified => "FOLD_STYLE_UNSPECIFIED",
            FoldStyle::CountDown => "FOLD_STYLE_COUNT_DOWN",
            FoldStyle::OnlyButton => "FOLD_STYLE_ONLY_BUTTON",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl FragmentPosition {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            FragmentPosition::Invalid => "INVALID",
            FragmentPosition::Pre => "PRE",
            FragmentPosition::Middle => "MIDDLE",
            FragmentPosition::Post => "POST",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl FragmentType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            FragmentType::AdFragment => "AD_FRAGMENT",
            FragmentType::OgvFragment => "OGV_FRAGMENT",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl GuideStyle {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            GuideStyle::StyleUnknown => "STYLE_UNKNOWN",
            GuideStyle::HorizontalImage => "HORIZONTAL_IMAGE",
            GuideStyle::VerticalText => "VERTICAL_TEXT",
            GuideStyle::SimpleText => "SIMPLE_TEXT",
            GuideStyle::ChargingText => "CHARGING_TEXT",
            GuideStyle::UniversalIntercept => "UNIVERSAL_INTERCEPT",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl PlayCtrl {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            PlayCtrl::Default => "PLAY_CTRL_DEFAULT",
            PlayCtrl::Simple => "PLAY_CTRL_SIMPLE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl PromptBarStyle {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            PromptBarStyle::Unknown => "PROMPT_BAR_STYLE_UNKNOWN",
            PromptBarStyle::Text => "TEXT",
            PromptBarStyle::CuringBenefits => "CURING_BENEFITS",
            PromptBarStyle::CardOpeningGift => "CARD_OPENING_GIFT",
            PromptBarStyle::Countdown => "COUNTDOWN",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl PromptBarType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            PromptBarType::Unknown => "PROMPT_BAR_TYPE_UNKNOWN",
            PromptBarType::OpenPromptBar => "OPEN_PROMPT_BAR",
            PromptBarType::TryPromptBar => "TRY_PROMPT_BAR",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl SettingItemStyle {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            SettingItemStyle::SettingStyleNone => "SETTING_STYLE_NONE",
            SettingItemStyle::SettingStyleSwitch => "SETTING_STYLE_SWITCH",
            SettingItemStyle::SettingStyleMore => "SETTING_STYLE_MORE",
            SettingItemStyle::SettingStyleSelect => "SETTING_STYLE_SELECT",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl SettingItemType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            SettingItemType::SettingNone => "SETTING_NONE",
            SettingItemType::SettingPlaybackRate => "SETTING_PLAYBACK_RATE",
            SettingItemType::SettingWatchLater => "SETTING_WATCH_LATER",
            SettingItemType::SettingDowNlOad => "SETTING_DOWNlOAD",
            SettingItemType::SettingSmallWindow => "SETTING_SMALL_WINDOW",
            SettingItemType::SettingFreyaenter => "SETTING_FREYAENTER",
            SettingItemType::SettingPlaybackMode => "SETTING_PLAYBACK_MODE",
            SettingItemType::SettingLoopPlayback => "SETTING_LOOP_PLAYBACK",
            SettingItemType::SettingTimingSwitch => "SETTING_TIMING_SWITCH",
            SettingItemType::SettingBackgroundPlay => "SETTING_BACKGROUND_PLAY",
            SettingItemType::SettingSubtitle => "SETTING_SUBTITLE",
            SettingItemType::SettingSubtitleExchange => "SETTING_SUBTITLE_EXCHANGE",
            SettingItemType::SettingFlipConf => "SETTING_FLIP_CONF",
            SettingItemType::SettingMorePlay => "SETTING_MORE_PLAY",
            SettingItemType::SettingShake => "SETTING_SHAKE",
            SettingItemType::SettingSkipOped => "SETTING_SKIP_OPED",
            SettingItemType::SettingNote => "SETTING_NOTE",
            SettingItemType::SettingReport => "SETTING_REPORT",
            SettingItemType::SettingFeedback => "SETTING_FEEDBACK",
            SettingItemType::SettingFreeGift => "SETTING_FREE_GIFT",
            SettingItemType::SettingDub => "SETTING_DUB",
            SettingItemType::SettingListen => "SETTING_LISTEN",
            SettingItemType::SettingProject => "SETTING_PROJECT",
            SettingItemType::SettingPicSize => "SETTING_PIC_SIZE",
...
impl SettingJumpType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            SettingJumpType::None => "SETTING_JUMP_TYPE_NONE",
            SettingJumpType::OpenUrl => "SETTING_JUMP_TYPE_OPEN_URL",
            SettingJumpType::HalfScreen => "SETTING_JUMP_TYPE_HALF_SCREEN",
            SettingJumpType::OpenUrlByOuterBrowser => {
...
impl ShowStyleType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ShowStyleType::Unknown => "SHOW_STYLE_TYPE_UNKNOWN",
            ShowStyleType::Ordinary => "SHOW_STYLE_TYPE_ORDINARY",
            ShowStyleType::Resident => "SHOW_STYLE_TYPE_RESIDENT",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ToastType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ToastType::Unknown => "TOAST_TYPE_UNKNOWN",
            ToastType::VipContentRemind => "VIP_CONTENT_REMIND",
            ToastType::VipDefinitionRemind => "VIP_DEFINITION_REMIND",
            ToastType::VipDefinitionGuide => "VIP_DEFINITION_GUIDE",
            ToastType::OgvVideoStartToast => "OGV_VIDEO_START_TOAST",
            ToastType::ChargingToast => "CHARGING_TOAST",
            ToastType::VipSkipFragmentToast => "VIP_SKIP_FRAGMENT_TOAST",
            ToastType::VipAiFixDefinitionRemind => "VIP_AI_FIX_DEFINITION_REMIND",
            ToastType::NewUserDefinitionRemind => "NEW_USER_DEFINITION_REMIND",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
