...
impl FeedCardType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            FeedCardType::Unknown => "FEED_CARD_TYPE_UNKNOWN",
            FeedCardType::UserRating => "FEED_CARD_TYPE_USER_RATING",
            FeedCardType::LeadCollection => "FEED_CARD_TYPE_LEAD_COLLECTION",
            FeedCardType::Item => "FEED_CARD_TYPE_ITEM",
            FeedCardType::Task => "FEED_CARD_TYPE_TASK",
        }
    }
...
impl FeedCardUserRatingOptionType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            FeedCardUserRatingOptionType::Unknown => {
                "FEED_CARD_USER_RATING_OPTION_TYPE_UNKNOWN"
            }
            FeedCardUserRatingOptionType::VeryDissatisfied => {
                "FEED_CARD_USER_RATING_OPTION_TYPE_VERY_DISSATISFIED"
            }
            FeedCardUserRatingOptionType::Dissatisfied => {
                "FEED_CARD_USER_RATING_OPTION_TYPE_DISSATISFIED"
            }
            FeedCardUserRatingOptionType::Average => {
                "FEED_CARD_USER_RATING_OPTION_TYPE_AVERAGE"
            }
            FeedCardUserRatingOptionType::Satisfied => {
                "FEED_CARD_USER_RATING_OPTION_TYPE_SATISFIED"
            }
            FeedCardUserRatingOptionType::VerySatisfied => {
...
impl TopicCardType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            TopicCardType::FeedCard => "FEED_CARD",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl TopicCategory {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            TopicCategory::Default => "Default",
            TopicCategory::Questions => "Questions",
            TopicCategory::IpTopic => "IPTopic",
            TopicCategory::Commerce => "Commerce",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl TopicTopCardType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            TopicTopCardType::UnknownType => "Unknown_Type",
            TopicTopCardType::CapsulesType => "Capsules_Type",
            TopicTopCardType::TrafficCardType => "Traffic_Card_Type",
            TopicTopCardType::GameCardType => "Game_Card_Type",
            TopicTopCardType::TimeLineType => "Time_Line_Type",
            TopicTopCardType::LargeCoverInlineType => "Large_Cover_Inline_Type",
            TopicTopCardType::ReservationCardType => "Reservation_Card_Type",
            TopicTopCardType::EsportCardType => "Esport_Card_Type",
            TopicTopCardType::IpTopicCardType => "IPTopic_Card_Type",
            TopicTopCardType::HeadClickAreaCardType => "Head_Click_Area_Card_Type",
            TopicTopCardType::ItemCardType => "Item_Card_Type",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod topic_server {
    ...
    ///
    #[derive(Debug)]
    pub struct TopicServer<T: Topic> {
        inner: Arc<T>,
    ...
    impl<T: Topic> Clone for TopicServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Topic> tonic::server::NamedService for TopicServer<T> {
        const NAME: &'static str = "bilibili.app.topic.v1.Topic";
    }
}
