...
impl InteractConnectType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            InteractConnectType::All => "InteractConnectTypeAll",
            InteractConnectType::OnlyVoice => "InteractConnectTypeOnlyVoice",
            InteractConnectType::OnlyVideo => "InteractConnectTypeOnlyVideo",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl InteractJoinType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            InteractJoinType::Invalid => "InteractJoinTypeInvalid",
            InteractJoinType::Invitation => "InteractJoinTypeInvitation",
            InteractJoinType::Apply => "InteractJoinTypeApply",
            InteractJoinType::ChannelLink => "InteractJoinTypeChannelLink",
            InteractJoinType::PullUp => "InteractJoinTypePullUp",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl InteractModeType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            InteractModeType::InteractModeB2b => "InteractModeB2B",
            InteractModeType::InteractModeB2c => "InteractModeB2C",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl InteractPositionMode {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            InteractPositionMode::Default => "InteractPositionModeDefault",
            InteractPositionMode::Chronological => "InteractPositionModeChronological",
            InteractPositionMode::Custom => "InteractPositionModeCustom",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl RoomStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            RoomStatus::NotStart => "RoomStatusNotStart",
            RoomStatus::Started => "RoomStatusStarted",
            RoomStatus::Ended => "RoomStatusEnded",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl SessionStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            SessionStatus::NotStart => "SessionStatusNotStart",
            SessionStatus::Started => "SessionStatusStarted",
            SessionStatus::Ended => "SessionStatusEnded",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
