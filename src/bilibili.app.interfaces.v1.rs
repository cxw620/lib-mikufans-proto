...
impl CommentType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            CommentType::None => "comment_type_none",
            CommentType::Redirect => "comment_type_redirect",
            CommentType::Judge => "comment_type_judge",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl FacialRecognitionVerifyFrom {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            FacialRecognitionVerifyFrom::VerifyUnknownFrom => "VerifyUnknownFrom",
            FacialRecognitionVerifyFrom::VerifyFromGuardian => "VerifyFromGuardian",
            FacialRecognitionVerifyFrom::VerifyFromAppeal => "VerifyFromAppeal",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl HistorySource {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            HistorySource::History => "history",
            HistorySource::Shopping => "shopping",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ModelStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ModelStatus::CloseStatus => "CloseStatus",
            ModelStatus::OpenStatus => "OpenStatus",
            ModelStatus::NotSetStatus => "NotSetStatus",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl PwdFrom {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            PwdFrom::UnknownFrom => "UnknownFrom",
            PwdFrom::TeenagersAntiAddictionFrom => "TeenagersAntiAddictionFrom",
            PwdFrom::TeenagersCurfewFrom => "TeenagersCurfewFrom",
            PwdFrom::TeenagersLoginFrom => "TeenagersLoginFrom",
            PwdFrom::TeenagersLogOutFrom => "TeenagersLogOutFrom",
            PwdFrom::FamilyAntiAddictionFrom => "FamilyAntiAddictionFrom",
            PwdFrom::FamilyCurfewFrom => "FamilyCurfewFrom",
            PwdFrom::FamilyLogOutFrom => "FamilyLogOutFrom",
            PwdFrom::FamilyTimeLockFrom => "FamilyTimeLockFrom",
            PwdFrom::TeenagersQuitPwdFrom => "TeenagersQuitPwdFrom",
            PwdFrom::TeenagersModifyPwdFrom => "TeenagersModifyPwdFrom",
            PwdFrom::FamilyQuitFrom => "FamilyQuitFrom",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod history_server {
    ...
    ///
    #[derive(Debug)]
    pub struct HistoryServer<T: History> {
        inner: Arc<T>,
    ...
    impl<T: History> HistoryServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T: History> Clone for HistoryServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: History> tonic::server::NamedService for HistoryServer<T> {
        const NAME: &'static str = "bilibili.app.interfaces.v1.History";
    }
}
/// Generated server implementations.
pub mod media_server {
    ...
    impl<T: Media> tonic::server::NamedService for MediaServer<T> {
        const NAME: &'static str = "bilibili.app.interfaces.v1.Media";
    }
}
/// Generated server implementations.
pub mod search_server {
    ...
    impl<T: Search> tonic::server::NamedService for SearchServer<T> {
        const NAME: &'static str = "bilibili.app.interfaces.v1.Search";
    }
}
/// Generated server implementations.
pub mod search_test_server {
    ...
    #[async_trait]
    pub trait SearchTest: Send + Sync + 'static {
        ///
        async fn not_exist(
            &self,
            request: tonic::Request<super::SuggestionResult3Req>,
    ...
    ///
    #[derive(Debug)]
    pub struct SearchTestServer<T: SearchTest> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T: SearchTest> SearchTestServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T: SearchTest> Clone for SearchTestServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: SearchTest> tonic::server::NamedService for SearchTestServer<T> {
        const NAME: &'static str = "bilibili.app.interfaces.v1.SearchTest";
    }
}
/// Generated server implementations.
pub mod space_server {
    ...
    ///
    #[derive(Debug)]
    pub struct SpaceServer<T: Space> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T: Space> Clone for SpaceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Space> tonic::server::NamedService for SpaceServer<T> {
        const NAME: &'static str = "bilibili.app.interfaces.v1.Space";
    }
}
/// Generated server implementations.
pub mod teenagers_server {
    ...
    #[async_trait]
    pub trait Teenagers: Send + Sync + 'static {
        ///
    ...
    ///
    #[derive(Debug)]
    pub struct TeenagersServer<T: Teenagers> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T: Teenagers> TeenagersServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T: Teenagers> Clone for TeenagersServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Teenagers> tonic::server::NamedService for TeenagersServer<T> {
        const NAME: &'static str = "bilibili.app.interfaces.v1.Teenagers";
    }
}
