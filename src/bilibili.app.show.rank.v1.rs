...
pub mod rank_server {
    ...
    impl<T: Rank> Clone for RankServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Rank> tonic::server::NamedService for RankServer<T> {
        const NAME: &'static str = "bilibili.app.show.rank.v1.Rank";
    }
}
