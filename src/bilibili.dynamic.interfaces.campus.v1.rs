...
impl ActionType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ActionType::ActionNothing => "ACTION_NOTHING",
            ActionType::ActionCloseYellowBar => "ACTION_CLOSE_YELLOW_BAR",
        }
    }
...
pub mod campus_server {
    ...
    impl<T: Campus> tonic::server::NamedService for CampusServer<T> {
        const NAME: &'static str = "bilibili.dynamic.interfaces.campus.v1.Campus";
    }
}
