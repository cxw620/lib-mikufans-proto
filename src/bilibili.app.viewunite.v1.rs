...
impl CacheCode {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            CacheCode::Play => "PLAY",
            CacheCode::UpowerstateInactive => "UPOWERSTATE_INACTIVE",
            CacheCode::RepeatLastOperation => "REPEAT_LAST_OPERATION",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl MaterialBizType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            MaterialBizType::GeneralType => "GENERAL_TYPE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl TabType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            TabType::TabNone => "TAB_NONE",
            TabType::TabIntroduction => "TAB_INTRODUCTION",
            TabType::TabReply => "TAB_REPLY",
            TabType::TabOgvActivity => "TAB_OGV_ACTIVITY",
            TabType::TabCatalog => "TAB_CATALOG",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod view_server {
    ...
    impl<T: View> tonic::server::NamedService for ViewServer<T> {
        const NAME: &'static str = "bilibili.app.viewunite.v1.View";
    }
}
