...
impl ArcState {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ArcState::StateUnknown => "STATE_UNKNOWN",
            ArcState::Open => "OPEN",
            ArcState::Orange => "ORANGE",
            ArcState::Wait => "WAIT",
            ArcState::Recicle => "RECICLE",
            ArcState::Lock => "LOCK",
            ArcState::Fixed => "FIXED",
            ArcState::UserDelay => "USER_DELAY",
            ArcState::FastPub => "FAST_PUB",
            ArcState::XcodeFail => "XCODE_FAIL",
        }
    }
...
impl CardType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            CardType::CardUnknown => "CARD_UNKNOWN",
            CardType::Pubguide => "PUBGUIDE",
            CardType::Ugc => "UGC",
            CardType::Opus => "OPUS",
            CardType::More => "MORE",
        }
...
impl DisplayPos {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            DisplayPos::UnknownDisplaytype => "UNKNOWN_DISPLAYTYPE",
            DisplayPos::VipButtonStatic => "VIP_BUTTON_STATIC",
            DisplayPos::VipButtonDynamic => "VIP_BUTTON_DYNAMIC",
            DisplayPos::VipButtonBirthday => "VIP_BUTTON_BIRTHDAY",
            DisplayPos::VipBackground => "VIP_BACKGROUND",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl OpusState {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            OpusState::OpusUnknown => "OPUS_UNKNOWN",
            OpusState::OpusOpen => "OPUS_OPEN",
            OpusState::OpusNoForward => "OPUS_NO_FORWARD",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod mine_server {
    ...
    #[async_trait]
    pub trait Mine: Send + Sync + 'static {
        ///
    ...
    impl<T: Mine> Clone for MineServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Mine> tonic::server::NamedService for MineServer<T> {
        const NAME: &'static str = "bilibili.app.mine.v1.Mine";
    }
}
