...
impl LiveInteractBusinessType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            LiveInteractBusinessType::Node => "LiveInteractBusinessTypeNode",
            LiveInteractBusinessType::MultiVoice => "LiveInteractBusinessTypeMultiVoice",
        }
    }
...
impl LiveInteractOperationType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            LiveInteractOperationType::Invalid => "LiveInteractOperationTypeInvalid",
            LiveInteractOperationType::Accept => "LiveInteractOperationTypeAccept",
            LiveInteractOperationType::Reject => "LiveInteractOperationTypeReject",
            LiveInteractOperationType::Cancel => "LiveInteractOperationTypeCancel",
            LiveInteractOperationType::NoReply => "LiveInteractOperationTypeNoReply",
            LiveInteractOperationType::Invited => "LiveInteractOperationTypeInvited",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl LiveMultiVoiceRole {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            LiveMultiVoiceRole::Common => "LiveMultiVoiceRoleCommon",
            LiveMultiVoiceRole::Manager => "LiveMultiVoiceRoleManager",
            LiveMultiVoiceRole::Anchor => "LiveMultiVoiceRoleAnchor",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
