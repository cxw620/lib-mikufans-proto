...
impl DmMaskWallBizType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            DmMaskWallBizType::Unknown => "Unknown",
            DmMaskWallBizType::Ogv => "OGV",
            DmMaskWallBizType::BizPic => "BizPic",
            DmMaskWallBizType::Mute => "Mute",
            DmMaskWallBizType::Record => "Record",
            DmMaskWallBizType::Cloud => "Cloud",
            DmMaskWallBizType::Aigc => "AIGC",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl DmMaskWallContentType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            DmMaskWallContentType::Unknown => "DmMaskWallContentTypeUnknown",
            DmMaskWallContentType::Text => "DmMaskWallContentTypeText",
            DmMaskWallContentType::Pic => "DmMaskWallContentTypePic",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl PostPanelBizType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            PostPanelBizType::PlotLeak => "PostPanelBizTypePlotLeak",
            PostPanelBizType::AntiHarassment => "PostPanelBizTypeAntiHarassment",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod dm_server {
    ...
    impl<T: Dm> Clone for DmServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Dm> tonic::server::NamedService for DmServer<T> {
        const NAME: &'static str = "bilibili.community.service.dm.v1.DM";
    }
}
