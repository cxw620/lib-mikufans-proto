...
pub mod click_req {
    ...
    impl ClickAction {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ClickAction::Invalid => "INVALID",
                ClickAction::Share => "SHARE",
            }
        }
...
pub mod event_req {
    ...
    impl EventType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                EventType::InvalidEventType => "INVALID_EventType",
                EventType::GuideBarShow => "GUIDE_BAR_SHOW",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod follow_relation {
    ...
    impl RelationStatus {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                RelationStatus::UnspecifiedRelationStatus => "UNSPECIFIED_RelationStatus",
                RelationStatus::NoFollow => "NO_FOLLOW",
                RelationStatus::Following => "FOLLOWING",
                RelationStatus::Followed => "FOLLOWED",
                RelationStatus::MutualFollowing => "MUTUAL_FOLLOWING",
                RelationStatus::SpecialFollowing => "SPECIAL_FOLLOWING",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod menu_subscribe_req {
    ...
    impl SubscribeAction {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                SubscribeAction::InvalidSubscribeAction => "INVALID_SubscribeAction",
                SubscribeAction::AddSubscribeAction => "ADD_SubscribeAction",
                SubscribeAction::DelSubscribeAction => "DEL_SubscribeAction",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod page_option {
    ...
    impl Direction {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Direction::ScrollDown => "SCROLL_DOWN",
                Direction::ScrollUp => "SCROLL_UP",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod playlist_offset {
    ...
    impl PlaylistScrollDirection {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                PlaylistScrollDirection::Down => "DOWN",
                PlaylistScrollDirection::Up => "UP",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod rcmd_playlist_req {
    ...
    impl RcmdFrom {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                RcmdFrom::UnspecifiedRcmdFrom => "UNSPECIFIED_RcmdFrom",
                RcmdFrom::UpArchiveRcmdFrom => "UP_ARCHIVE_RcmdFrom",
                RcmdFrom::IndexEntry => "INDEX_ENTRY",
                RcmdFrom::ArchiveView => "ARCHIVE_VIEW",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod thumb_up_req {
    ...
    impl ThumbType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ThumbType::Like => "LIKE",
                ThumbType::CancelLike => "CANCEL_LIKE",
                ThumbType::Dislike => "DISLIKE",
                ThumbType::CancelDislike => "CANCEL_DISLIKE",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod top_card {
    ...
    impl PlayStrategy {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                PlayStrategy::NoInterrupt => "NO_INTERRUPT",
                PlayStrategy::PlayTarget => "PLAY_TARGET",
                PlayStrategy::PlayFirst => "PLAY_FIRST",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl TopCardType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            TopCardType::UnspecifiedTopCardType => "UNSPECIFIED_TopCardType",
...
pub mod listener_server {
    ...
    ///
    #[derive(Debug)]
    pub struct ListenerServer<T: Listener> {
        inner: Arc<T>,
    ...
    impl<T: Listener> ListenerServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T: Listener> Clone for ListenerServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Listener> tonic::server::NamedService for ListenerServer<T> {
        const NAME: &'static str = "bilibili.app.listener.v1.Listener";
    }
}
/// Generated server implementations.
pub mod music_server {
    ...
    #[async_trait]
    pub trait Music: Send + Sync + 'static {
        ///
        async fn click(
            &self,
    ...
    ///
    #[derive(Debug)]
    pub struct MusicServer<T: Music> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T: Music> Clone for MusicServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Music> tonic::server::NamedService for MusicServer<T> {
        const NAME: &'static str = "bilibili.app.listener.v1.Music";
    }
}
