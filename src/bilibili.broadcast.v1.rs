...
pub mod push_message_resp {
    ...
    impl DisplayType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                DisplayType::DisPlayText => "DisPlayText",
                DisplayType::DisplaySatic => "DisplaySatic",
                DisplayType::DisplayGif => "DisplayGif",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
    ...
    impl ImageFrame {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ImageFrame::FrameUnknown => "FRAME_UNKNOWN",
                ImageFrame::FrameLive => "FRAME_LIVE",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
    ...
    impl ImageMarker {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ImageMarker::MarkerUnknown => "MARKER_UNKNOWN",
                ImageMarker::MarkerLive => "MARKER_LIVE",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
    ...
    impl ImagePosition {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ImagePosition::ImagePosUnknown => "IMAGE_POS_UNKNOWN",
                ImagePosition::ImagePosLeft => "IMAGE_POS_LEFT",
                ImagePosition::ImagePosRight => "IMAGE_POS_RIGHT",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
    ...
    impl PopType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                PopType::TopToBottom => "TopToBottom",
                PopType::RightToLeft => "RightToLeft",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod broadcast_room_server {
    ...
    #[async_trait]
    pub trait BroadcastRoom: Send + Sync + 'static {
        ///
        async fn enter(
            &self,
    ...
    ///
    #[derive(Debug)]
    pub struct BroadcastRoomServer<T: BroadcastRoom> {
        inner: Arc<T>,
    ...
    impl<T: BroadcastRoom> BroadcastRoomServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T: BroadcastRoom> Clone for BroadcastRoomServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: BroadcastRoom> tonic::server::NamedService for BroadcastRoomServer<T> {
        const NAME: &'static str = "bilibili.broadcast.v1.BroadcastRoom";
    }
}
/// Generated server implementations.
pub mod laser_server {
    ...
    #[async_trait]
    pub trait Laser: Send + Sync + 'static {
        ///
    ...
    ///
    #[derive(Debug)]
    pub struct LaserServer<T: Laser> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T: Laser> Clone for LaserServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Laser> tonic::server::NamedService for LaserServer<T> {
        const NAME: &'static str = "bilibili.broadcast.v1.Laser";
    }
}
/// Generated server implementations.
pub mod mod_manager_server {
    ...
    #[async_trait]
    pub trait ModManager: Send + Sync + 'static {
        ///
    ...
    ///
    #[derive(Debug)]
    pub struct ModManagerServer<T: ModManager> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T: ModManager> ModManagerServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T: ModManager> Clone for ModManagerServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: ModManager> tonic::server::NamedService for ModManagerServer<T> {
        const NAME: &'static str = "bilibili.broadcast.v1.ModManager";
    }
}
/// Generated server implementations.
pub mod push_server {
    ...
    impl<T: Push> tonic::server::NamedService for PushServer<T> {
        const NAME: &'static str = "bilibili.broadcast.v1.Push";
    }
}
/// Generated server implementations.
pub mod test2_server {
    ...
    impl<T: Test2> tonic::server::NamedService for Test2Server<T> {
        const NAME: &'static str = "bilibili.broadcast.v1.Test2";
    }
}
