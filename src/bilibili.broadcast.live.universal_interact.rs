...
pub mod interact_scene_configuration {
    ...
    impl InteractMode {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                InteractMode::B2b => "InteractModeB2B",
                InteractMode::B2c => "InteractModeB2C",
            }
        }
...
pub mod universal_interact_stream_control {
    ...
    impl MuteLocalMode {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                MuteLocalMode::MuteModeNone => "mute_mode_none",
                MuteLocalMode::MuteModePacket => "mute_mode_packet",
                MuteLocalMode::MuteModeCapture => "mute_mode_capture",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
    ...
    impl PubStatus {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                PubStatus::None => "pub_status_none",
                PubStatus::Audio => "pub_status_audio",
                PubStatus::Video => "pub_status_video",
                PubStatus::All => "pub_status_all",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl CloseUserReason {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            CloseUserReason::Invalid => "CloseUserReason_Invalid",
            CloseUserReason::DissolveChannel => "CloseUserReason_DissolveChannel",
            CloseUserReason::Remove => "CloseUserReason_Remove",
            CloseUserReason::Banned => "CloseUserReason_Banned",
            CloseUserReason::Normal => "CloseUserReason_Normal",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl InteractScene {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            InteractScene::Voice1V1 => "InteractSceneVoice1V1",
            InteractScene::VideoB2b => "InteractSceneVideoB2B",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl LayoutCellOpen {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            LayoutCellOpen::Invalid => "LayoutCellOpenInvalid",
            LayoutCellOpen::Visible => "LayoutCellOpenVisible",
            LayoutCellOpen::Invisible => "LayoutCellOpenInvisible",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl PlayMode {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            PlayMode::Explicit => "play_mode_explicit",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl SubMode {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            SubMode::None => "sub_mode_none",
            SubMode::Audio => "sub_mode_audio",
            SubMode::Video => "sub_mode_video",
            SubMode::All => "sub_mode_all",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl UniversalInteractActionType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            UniversalInteractActionType::Apply => "UniversalInteractActionTypeApply",
            UniversalInteractActionType::Invitation => {
                "UniversalInteractActionTypeInvitation"
            }
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
...
impl UniversalInteractOperationType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            UniversalInteractOperationType::UniversalInteractOperationInvalid => {
                "UniversalInteractOperationInvalid"
            }
            UniversalInteractOperationType::UniversalInteractOperationAccept => {
                "UniversalInteractOperationAccept"
            }
            UniversalInteractOperationType::UniversalInteractOperationReject => {
                "UniversalInteractOperationReject"
            }
            UniversalInteractOperationType::UniversalInteractOperationCancel => {
                "UniversalInteractOperationCancel"
            }
            UniversalInteractOperationType::UniversalInteractOperationTimeoutCancel => {
...
impl UniversalItemStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            UniversalItemStatus::Unknown => "UniversalItemStatus_Unknown",
            UniversalItemStatus::NotLiving => "UniversalItemStatus_NotLiving",
            UniversalItemStatus::NotAllow => "UniversalItemStatus_NotAllow",
            UniversalItemStatus::Connected => "UniversalItemStatus_Connected",
            UniversalItemStatus::ConnectedNoPosition => {
                "UniversalItemStatus_Connected_NoPosition"
            }
            UniversalItemStatus::AllowInvitation => "UniversalItemStatus_AllowInvitation",
            UniversalItemStatus::Applying => "UniversalItemStatus_Applying",
            UniversalItemStatus::Inviting => "UniversalItemStatus_Inviting",
            UniversalItemStatus::Connecting => "UniversalItemStatus_Connecting",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
