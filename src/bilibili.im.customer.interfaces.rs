...
pub mod customer_interface_server {
    ...
    #[async_trait]
    pub trait CustomerInterface: Send + Sync + 'static {
        ///
    ...
    ///
    #[derive(Debug)]
    pub struct CustomerInterfaceServer<T: CustomerInterface> {
        inner: Arc<T>,
    ...
    impl<T: CustomerInterface> CustomerInterfaceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T: CustomerInterface> Clone for CustomerInterfaceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: CustomerInterface> tonic::server::NamedService
    for CustomerInterfaceServer<T> {
        const NAME: &'static str = "bilibili.im.customer.interfaces.CustomerInterface";
    }
}
