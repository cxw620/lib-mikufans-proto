...
pub mod resource {
    ...
    impl BizKind {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                BizKind::Unknown => "UNKNOWN",
                BizKind::LikeSuccess => "LIKE_SUCCESS",
                BizKind::ReplySuccess => "REPLY_SUCCESS",
                BizKind::ReplyEasterEgg => "REPLY_EASTER_EGG",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl UserCallbackAction {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            UserCallbackAction::Default => "USER_CALLBACK_ACTION_DEFAULT",
            UserCallbackAction::Dismiss => "USER_CALLBACK_ACTION_DISMISS",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl UserCallbackScene {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            UserCallbackScene::Default => "USER_CALLBACK_SCENE_DEFAULT",
            UserCallbackScene::Insert => "USER_CALLBACK_SCENE_INSERT",
            UserCallbackScene::RecommendSuperbReply => {
...
pub mod reply_server {
    ...
    impl<T: Reply> tonic::server::NamedService for ReplyServer<T> {
        const NAME: &'static str = "bilibili.main.community.reply.v2.Reply";
    }
}
