...
impl Action {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Action::CancelLike => "ACTION_CANCEL_LIKE",
            Action::Dislike => "ACTION_DISLIKE",
            Action::CancelDislike => "ACTION_CANCEL_DISLIKE",
        }
    }
...
pub mod search_server {
    ...
    impl<T: Search> tonic::server::NamedService for SearchServer<T> {
        const NAME: &'static str = "bilibili.app.search.v2.Search";
    }
}
