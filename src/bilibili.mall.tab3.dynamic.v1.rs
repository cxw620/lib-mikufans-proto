...
impl ReserveState {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ReserveState::Invalid => "INVALID",
            ReserveState::Reserve => "Reserve",
            ReserveState::PrizeReserve => "PrizeReserve",
            ReserveState::CancelReserve => "CancelReserve",
            ReserveState::Cancel => "Cancel",
            ReserveState::PrizeCancel => "PrizeCancel",
            ReserveState::Going => "Going",
            ReserveState::End => "End",
            ReserveState::Expired => "Expired",
            ReserveState::Canceled => "Canceled",
        }
    }
...
impl UpActReserveRelationLotteryType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            UpActReserveRelationLotteryType::Default => {
                "UpActReserveRelationLotteryTypeDefault"
            }
            UpActReserveRelationLotteryType::Cron => {
                "UpActReserveRelationLotteryTypeCron"
            }
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
...
pub mod opus_server {
    ...
    impl<T: Opus> tonic::server::NamedService for OpusServer<T> {
        const NAME: &'static str = "bilibili.mall.tab3.dynamic.v1.Opus";
    }
}
